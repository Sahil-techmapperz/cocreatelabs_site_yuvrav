...
const Mission = () => {
  return (
    <>
      <div className="mission-parent-container max-sm:p-[2em] font-sans">
        <div className="mission-content-container max-sm:gap-[3rem]">
          ...
          <div className="container mission-content mt-[40px]">
