...
const Investapply = () => {
  return (
    <>
      <div className="invest-apply-parent-container font-sans">
        ...
        <div className="container invest-apply-top-container">
          ...
          <div className="get-intouch-btn">
            <Link to="/eventregistration"> Get in touch with us</Link>

          </div>
        </div>
        <div className="container invest-apply-cards-container">
          <div className="container invest-apply-container">
            <div className="container invest-apply-left transform scale-100 hover:scale-105 max-sm:w-[250px] max-sm:h-[200px]">
              <img src={mask1} alt="" />
              <br /> <br />
            ...
            <div className="container invest-apply-right transform scale-100 hover:scale-105 max-sm:w-[250px] max-sm:h-[200px]">
              <img src={mask2} alt="" />
              <br /> <br />
          ...
          <div className="container invest-apply-container max-sm:gap-0">
            <div className="container invest-apply-left transform scale-100 hover:scale-105 max-sm:w-[250px] max-sm:h-[200px]">
              <img src={mask3} alt="" />
              <br /> <br />
